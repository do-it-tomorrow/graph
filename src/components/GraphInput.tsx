    ...
    <>
      <div
        className="font-jetbrains flex flex-col border-2 rounded-lg bg-block
          ...
          space-y-3 z-10"
      >
        <h3 className="font-bold text-lg">图表数据</h3>

        <br />

        <h4 className="text-base font-semibold">存在的节点</h4>
        <textarea
          wrap="off"
          rows={1}
        ...
        <h4 className="text-base font-semibold">添加标签</h4>
        <textarea
          wrap="off"
